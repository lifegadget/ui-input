...
var NumberInput = BaseInput.extend({
  layout: layout,
      ...
      'max',
      {
        ...
        rule: function(context, eventType, event) {
          let result = {};
            ...
            result.animate = true;
            result.sound = true;
  					result.message = [`Maximum value of ${context.get('max')} was surpassed, resetting to maximum.`, {expiry: 2000, type: 'warning'}];
  					return result;
  				} else {
  					return result;
  				}
...
NumberInput[Ember.NAME_KEY] = 'number-input Subclass';
